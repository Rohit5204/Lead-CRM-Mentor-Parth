            ...
            <Row>
                ...
                <Col>
                    <SimpleCard title="Preview Card">
                        ...
                        <Card style={{ borderRadius: '29px' }}>
                            <Card.Img variant="top" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRUQc1LSJmPw-vGxpB2QLAOJzReuhIrHk4u7g&usqp=CAU" />

                            <Card.Body className="text-center">
                                <h5 tag="h4">{user.name}</h5>
