          ...
          <SimpleCard title="Request Quotation">
            ...
            <Row>
              <Col>
                ...
                <Form.Control onChange={(e) => setAmount(e.target.value)} value={amount} />
              </Col>
              <Col>
                <Form.Label>Discount</Form.Label>
                <Form.Control onChange={(e) => setDiscount(e.target.value)} value={discount} />
              </Col>
              <Col>
                <Form.Label>Grand Total</Form.Label>
                <Form.Control onChange={(e) => setGrandTotal(e.target.value)} value={grandTotal} />
              </Col>
            </Row>
            <Row>
              <Col>
